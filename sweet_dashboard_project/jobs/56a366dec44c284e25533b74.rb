...
class Reddit
    ...
    def getTopPostsPerSubreddit()  
        puts "hello74"
        uri = URI("http://0.0.0.0:8080/api/?user_id=56a366dec44c284e25533b74")
...
SCHEDULER.every '20s', :first_in => 0 do |job|
  ...
  send_event('reddit56a366dec44c284e25533b74', { :posts => posts })
end	
...
#        puts twee_arr
      ...
      send_event('twitter_mentions156a366dec44c284e25533b74', comments: twee_arr[0])
      send_event('twitter_mentions256a366dec44c284e25533b74', comments: twee_arr[1])
	  send_event('twitter_mentions356a366dec44c284e25533b74', comments: twee_arr[2])
      send_event('twitter_mentions456a366dec44c284e25533b74', comments: twee_arr[3])
...
SCHEDULER.every '20s', :first_in => 0 do |job|
  ...
  while max > (min+page_size)
    send_event('news56a366dec44c284e25533b74', { items: newswhip_article.slice(min, page_size)})
	sleep(10)
  ...
  send_event('news56a366dec44c284e25533b74', { items: newswhip_article.slice(min..max)})
...
SCHEDULER.every '20s', :first_in => 0 do |job|
 ...
 ch_id = ["UC1b6tyXZTHdIZ5vmgoAqn9w","UCx2HcmpB-UZGkMXOCJ4QIVA","UCzUYuC_9XdUUdrnyLii8WYg"]
...
arr = []
 ...
 for i in 0..4
	send_event('youtube_player156a366dec44c284e25533b74', { :items => channel_arr[0].slice(min, len) })
	send_event('youtube_player256a366dec44c284e25533b74', { :items => channel_arr[1].slice(min, len) })
	send_event('youtube_player356a366dec44c284e25533b74', { :items => channel_arr[2].slice(min, len) })
	send_event('youtube_player456a366dec44c284e25533b74', { :items => channel_arr[3].slice(min, len) })
    sleep(60)
    min=min+1    
 end
